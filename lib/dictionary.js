...
var Dictionary = function () {
  ...
  (0, _createClass3.default)(Dictionary, [{
        ...
        return _regenerator2.default.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                dPath = (0, _utils.baseDir)() + "/dictionary/";
                wordsFile = (0, _utils.exists)("" + dPath + name + "/words.json");
                accentFile = (0, _utils.exists)("" + dPath + name + "/accents.json");
                stopFile = (0, _utils.exists)("" + dPath + name + "/stopwords.json");
                packedFile = (0, _utils.exists)("" + dPath + name + "/dictionary.gz");
              ...
              case 14:
                ...
                _context2.next = 19;
                return (0, _utils.unpackZip)(packedFile, "" + dPath + name);
              ...
              case 22:
                ...
                if (!stopFile) stopFile = (0, _utils.exists)(dPath + "/default/stopwords.json");
                // Load stopwords
                try {
                  this.stopWords = JSON.parse((0, _utils.getFile)(stopFile));
                } catch (e) {
                  this.stopWords = [];
                }

                // Accent file fallback
                if (!accentFile) accentFile = (0, _utils.exists)(dPath + "/default/accents.json");
                // Load accent lookups
                try {
                  this.accentLookup = JSON.parse((0, _utils.getFile)(accentFile));
                } catch (e) {
                  this.accentLookup = {};
                }
    ...
    value: function initContext(config) {
      var dPath = (0, _utils.baseDir)() + "/dictionary/";
      var modelFile = (0, _utils.exists)("" + dPath + config.name + "/context.bin");

      // Load context
      if (!modelFile) {
        modelFile = (0, _utils.exists)(dPath + "/default/context.bin");
      }
    ...
    value: function loadFile(dictFile) {
      ...
      // Try to open file
      try {
        fileContent = (0, _utils.getFile)(dictFile);
      } catch (e) {
